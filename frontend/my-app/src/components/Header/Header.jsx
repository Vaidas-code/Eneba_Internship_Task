...
export default function Header() {
  return (
    <header className="h2DMqW app-header">
      ...
      <div className="D8cFGT">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 69 69" style={{width:'auto', height:32}}></svg>
      </div>
